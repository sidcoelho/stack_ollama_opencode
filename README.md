...
## Como executar
O arquivo a ser executado é o _script wrapper_ localizado na pasta `bin`. Para facilitar, existe duas opções:
...
Com isso, é só ir até a pasta onde seu projeto se encontra e executar `opencode`. Ele será aberto na versão _[TUI](https://opencode.ai/docs/pt-br/tui/)_ e terá acesso aos arquivos do seu projeto.
